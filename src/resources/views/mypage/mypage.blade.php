    ...
    <div class="mypage__inner">
        ...
        <section class="mypage-user">
            <div class="mypage-user__avatar">
                ...
                <img src="{{ Storage::url($user->profile_image_path) }}" alt="プロフィール画像" class="mypage-user__avatar-img">
                @else
            ...
            <a
                href="{{ route('profile.edit', ['from' => 'mypage']) }}" class="mypage-user__edit-btn">
                プロフィールを編集
            </a>
        </section>
        ...
        <section class="mypage-items">
            <div class="mypage-items__grid">
                ...
                <article class="mypage-card">
                    <a href="{{ route('items.show', $item) }}" class="mypage-card__link">
